  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white pb-20" style={{fontFamily:'system-ui,sans-serif'}}>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-900 border-b border-gray-800">
        ...
        <div className="text-center">
          <h1 className="text-lg font-bold text-amber-400">メニュー管理</h1>
        ...
        <div className="px-4">
          ...
          {menu.length === 0 && (
            <div className="text-center py-16 text-gray-500">
              ...
              <div className="font-bold mb-2">メニューがありません</div>
              <button onClick={() => setMode('add')}
            ...
            {menu.map(item => (
              <div key={item.id}
                ...
                <div className="text-xs text-gray-400 mb-3">
                  {item.cookTime}分 · 付きっきり{item.attn}
                </div>
      ...
      {mode === 'add' && (
        <div className="px-4">
          <div className="text-sm font-bold text-gray-400 text-center mb-4">
            {editId ? '✏️ メニューを編集' : '＋ 新しいメニューを追加'}
          </div>

          {/* 料理名 */}
          <div className="bg-gray-900 rounded-2xl p-4 mb-3">
            <label className="text-xs text-gray-400 block mb-2">料理名</label>
          ...
          <div className="bg-gray-900 rounded-2xl p-4 mb-3">
            <label className="text-xs text-gray-400 block mb-2">
              調理時間：<span className="text-amber-400 font-black text-lg">{form.cookTime}分</span>
            </label>
          ...
          {/* 調理設備 */}
          <div className="bg-gray-900 rounded-2xl p-4 mb-3">
            <label className="text-xs text-gray-400 block mb-3">調理設備</label>
          ...
          <div className="bg-gray-900 rounded-2xl p-4 mb-4">
            <label className="text-xs text-gray-400 block mb-3">
              付きっきり度：<span className="text-amber-400 font-black">{['不要','低い','少し','普通','高い','常に'][form.attn]}</span>
            </label>
            <div className="flex gap-2">
              {[0,1,2,3,4,5].map(v => (
            ...
            <div className="text-xs text-gray-600 mt-2 text-center">0=放置OK（冷菜など）　5=常に目が離せない</div>
          </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-gray-900 border-t border-gray-800 flex">
        ...
        <Link href="/menu" className="flex-1 py-4 text-center text-xs text-amber-400 font-bold border-t-2 border-amber-400">メニュー</Link>
